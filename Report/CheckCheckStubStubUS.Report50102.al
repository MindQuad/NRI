report 50102 "Check/Stub/StubUS_VOX"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Report/CheckCheckStubStubUS.rdl';
        ...
        dataitem(GenJnlLine; "Gen. Journal Line")
        {
            ...
            dataitem(CheckPages; "Integer")
            {
                ...
                dataitem(PrintCheck; "Integer")
                {
                    ...
                    column(DollarSignBefore_CheckAmountText_DollarSignAfter; CheckAmountText + DollarSignAfter)
                    {
                    }
            ...
            begin
                ...
                if not TestPrint then begin
                    ...
                    CheckDateText :=
                      CheckTranslationManagement.FormatDate("Posting Date", CheckDateFormat::"DD MM YYYY", DateSeparator, CheckLanguage, DateIndicator);
                end else begin
